...
export async function GET(
  ...
  const { data, error } = await supabase
    ...
    .eq("id", idValidationResult.data.member_id)
    .maybeSingle();
...
export async function PUT(
  ...
  const idValidationResult = members_get_single.safeParse({ member_uid });
  ...
  const bodyValidationResult = members_put.safeParse(body);
